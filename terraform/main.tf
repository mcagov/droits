...
module "cloudwatch" {
  ...
  ecs_minimum_task_count                             = var.api_backofice_service_minimum_task_count
  ecs_webapp_service_minimum_task_count              = var.webapp_service_minimum_task_count
  ecs_cpu_utilization_high_threshold_percentage      = var.percentage_cpu_utilization_high_threshold
  ecs_memory_utilization_high_threshold_percentage   = var.percentage_memory_utilization_high_threshold
  ...
  ecs_memory_utilization_high_evaluation_periods     = var.memory_utilization_high_evaluation_periods
  lb_average_response_time_threshold                 = var.lb_average_response_time_threshold
  ecs_cpu_utilization_high_evaluation_periods        = var.cpu_utilization_high_evaluation_periods
