...
namespace Droits.Services
{
    ...
    public class DroitService : IDroitService{
        ...
        public async Task<List<Droit>> GetDroitsAsync() => await _repo.GetDroitsAsync();
        public async Task AddDroitAsync(Droit droit) => await _repo.AddDroitAsync(droit);
        public async Task<Droit?> GetDroitAsync(Guid id) => await _repo.GetDroitAsync(id);
